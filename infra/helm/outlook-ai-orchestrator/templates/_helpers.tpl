...
DB_POOL_MIN: {{ .Values.config.db.poolMin | quote }}
DB_POOL_MAX: {{ .Values.config.db.poolMax | quote }}
DB_STATEMENT_TIMEOUT_MS: {{ .Values.config.db.statementTimeoutMs | quote }}
DB_IDLE_TIMEOUT_MS: {{ .Values.config.db.idleTimeoutMs | quote }}
DB_CONNECTION_TIMEOUT_MS: {{ .Values.config.db.connectionTimeoutMs | quote }}
...
PROMPT_VERSION: {{ .Values.llm.promptVersion | quote }}
THREAD_MAX_MESSAGES: {{ .Values.llm.threadMaxMessages | quote }}
EMBEDDING_CACHE_ENABLED: {{ .Values.features.embeddingCache | quote }}
EMBEDDING_CACHE_TTL_DAYS: {{ .Values.features.embeddingCacheTtlDays | quote }}
