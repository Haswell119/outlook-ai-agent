...
Ce dépôt ne contient pas seulement une démo : il embarque le packaging de
production complet pour **Nutanix Kubernetes Platform (NKP)**, dimensionné
...
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | Architecture technique détaillée (§10 : déploiement NKP) |
